...
public class TerrenoSimple extends BranchGroup {
  ...
  Shape3D crearPlaca(ObjectArrayList<Vector3f>  subvertices){
       ...
       //FIXME: arreglar el color de la lava, se usa un filtro rgb, mirar aqui http://www.pagaelpato.com/tecno/colores.htm
       placa.setCoordinate(0, p1);   placa.setCoordinate(1, p2);    placa.setCoordinate(2, p3);    placa.setCoordinate(3, p4);
       placa.setColor(0, new Color3f(256/256f+subvertices.get(0).y/6.1f,  subvertices.get(0).y/2f+0f, 0.11f));
       placa.setColor(1, new Color3f(200/256f+subvertices.get(1).y/6.2f, subvertices.get(1).y/2f+0f, 0.12f));
       placa.setColor(2, new Color3f(230/256f+subvertices.get(2).y/6.3f, subvertices.get(2).y/2f+0f, 0.13f));
       placa.setColor(3, new Color3f(210/256f+subvertices.get(3).y/6.4f,subvertices.get(3).y/2f+0f, 0.15f));
