...
public class FractalLand3D extends JFrame {
    ...
    private double processArgs(String[] args) // 0 or 1 argument is acceptable
    {
    ...
    private double getFlatness(String arg) // flatness must be a double within the range MIN_FLAT to MAX_FLAT
    {
        double flatness;
        try {
