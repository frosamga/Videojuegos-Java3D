           ...
           for (int n=0;n<events.length;n++){
              if (events[n]  instanceof KeyEvent){
                ...
                if (ek.getID() == KeyEvent.KEY_PRESSED) {
                    ...
                    else if (ek.getKeyChar() == KeyEvent.VK_SPACE) personaje.disparo=true;
                    else if (ek.getKeyChar() == 'r') personaje.reinicio=true;
                    ...
                    else if (ek.getKeyChar() ==  KeyEvent.VK_SPACE)personaje.disparo=false;
                    else if (ek.getKeyChar() == 'r') personaje.reinicio=true;
                }
          }
        }
